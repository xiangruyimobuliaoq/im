 ...
 * 更新描述   ${TODO}
 */
@Layout(layoutId = R.layout.activity_welcom)
public class WelcomActivity extends BaseActivity {
    ...
    protected ViewGroup bottomPages;
    @BindView(R.id.start_messaging_button)
    protected TextView startMessagingButton;
    ...
    protected void init() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            animator.addState(new int[]{android.R.attr.state_pressed}, ObjectAnimator.ofFloat(startMessagingButton, "translationZ", 2, 4).setDuration(200));
            animator.addState(new int[]{}, ObjectAnimator.ofFloat(startMessagingButton, "translationZ", 4, 2).setDuration(200));
            ...
            public void onPageScrollStateChanged(int i) {
                if (i == ViewPager.SCROLL_STATE_IDLE || i == ViewPager.SCROLL_STATE_SETTLING) {
                    if (lastPage != viewPager.getCurrentItem()) {
                        ...
                        if(icons[lastPage] == R.mipmap.intro1)
                        {
                        ...
                        Animation outAnimation = AnimationUtils.loadAnimation(WelcomActivity.this, R.anim.icon_anim_fade_out);
                        ...
                        Animation inAnimation = AnimationUtils.loadAnimation(WelcomActivity.this, R.anim.icon_anim_fade_in);
